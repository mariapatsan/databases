...
При удалении резюме из резюме - таблца пользователи не затрагивается, так как каскад настроен только в одну стѾЀоу.
При изменеии id поьзоватея в пользователях - поле userid во всѵх его юме автоматически обновляется на нвое значение.
